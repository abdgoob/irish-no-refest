...
await sharp({
  ...
  .webp({ quality: 82 })
  .toFile("public/assets/restaurant/_pipeline/p0-contact-sheet-v4.webp");

await sharp("public/assets/restaurant/_pipeline/p0-contact-sheet-v4.webp").toFile(
  "public/assets/restaurant/_pipeline/p0-contact-sheet-final.webp",
);

console.log("contact-sheet-v4 + final", width, y);
