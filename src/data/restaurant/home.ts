...
export const prologue = {
  label: "PROLOGUE",
  quote:
    "“YOU WILL FORGET WHAT YOU ORDERED. YOU WILL REMEMBER HOW THE ROOM FELT—THE FIRST PINT, PLATES PASSED WITHOUT CEREMONY, STRANGERS TURNING INTO REGULARS, THE NIGHT STILL GOING WHEN THE STREETS GO QUIET. THIS HOUSE EXISTS FOR THAT.”",
} as const;
