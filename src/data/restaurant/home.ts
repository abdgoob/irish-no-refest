...
export const prologue = {
  label: "PROLOGUE",
  quote:
    "“PEOPLE DO NOT REMEMBER A MENU. THEY REMEMBER HOW A ROOM MADE THEM FEEL—THE PINT POURED RIGHT, THE PLATE IN THE MIDDLE OF THE TABLE, THE NIGHT THAT REFUSED TO END. WE OPENED THIS HOUSE FOR THAT.”",
} as const;
